...
export default function PrivateTour() {
  return (
    ...
    >
      <div className="relative flex flex-col items-center justify-center gap-6 overflow-hidden rounded-[40px] px-6 py-12 md:h-[569px] md:px-16 md:py-0">
        <video
        ...
        <div className="relative flex max-w-[518px] flex-col gap-2 text-center">
          <h2 className="font-sans text-[clamp(24px,6.5vw,32px)] font-medium leading-[1.15] text-white md:text-[60px] md:leading-[1.1]">
            Want a{" "}
