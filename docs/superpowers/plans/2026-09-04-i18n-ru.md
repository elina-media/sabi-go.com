...
- [x] **Step 1: Create `src/lib/i18n.ts`**
...
- [x] **Step 1: Rewrite `src/components/LanguageProvider.tsx`**
...
- [x] **Step 2: Rewrite `src/components/LanguageSwitcher.tsx`**
...
- [x] **Step 5 (controller, live browser check):** Run `npm run dev`, open
...
- [x] **Step 1: Create `src/data/copy.tsx`**
...
- [x] **Step 1: Rewrite `src/data/tours.ts`**
...
- [x] **Step 2: Confirm the expected breakage is exactly the consumer files**
...
- [x] **Step 1: Rewrite `src/data/reviews.ts`**
...
- [x] **Step 2: Confirm the expected breakage is exactly `ReviewCard.tsx`**
...
- [x] **Step 1: Rewrite `src/data/faq.ts`**
...
- [x] **Step 2: Confirm the expected breakage is exactly `FaqItem.tsx`**
...
- [x] **Step 1: Edit `src/components/NavbarContent.tsx`**
...
- [x] **Step 2: Edit `src/components/MobileMenu.tsx`**
...
- [x] **Step 5 (controller, live browser check):** With the switcher set
...
- [x] **Step 1: Edit `src/components/Hero.tsx`**
...
- [x] **Step 2: Edit `src/components/Features.tsx`**
...
- [x] **Step 5 (controller, live browser check):** On the home page with
...
- [x] **Step 1: Edit `src/components/Tours.tsx`**
...
- [x] **Step 2: Edit `src/components/TourCard.tsx`**
...
- [x] **Step 3: Edit `src/components/TourGallery.tsx`**
...
- [x] **Step 4: Edit `src/components/TourGallerySlider.tsx`**
...
- [x] **Step 7 (controller, live browser check):** On the home page with
...
- [x] **Step 1: Edit `src/components/PrivateTour.tsx`**
...
- [x] **Step 2: Edit `src/components/PrivateTourForm.tsx`**
...
- [x] **Step 3: Edit `src/components/BookingModal.tsx`**
...
- [x] **Step 6 (controller, live browser check):** With RU selected,
...
- [x] **Step 1: Edit `src/components/Reviews.tsx`**
...
- [x] **Step 2: Edit `src/components/ReviewCard.tsx`**
...
- [x] **Step 3: Edit `src/components/Faq.tsx`**
...
- [x] **Step 4: Edit `src/components/FaqItem.tsx`**
...
- [x] **Step 5: Edit `src/components/Footer.tsx`**
...
- [x] **Step 8 (controller, live browser check):** With RU selected,
...
- [x] **Step 1: Edit `src/components/TourHero.tsx`**
...
- [x] **Step 2: Edit `src/components/TourDetails.tsx`**
...
- [x] **Step 3: Edit `src/app/tours/[slug]/page.tsx`**
...
- [x] **Step 6 (controller, live browser check):** Open any
...
- [x] **Step 1 (controller, live browser check): Home page, EN → RU → EN**
...
- [x] **Step 2 (controller, live browser check): all 6 tour detail pages**
...
- [x] **Step 3 (controller): KZ/AR fallback and persistence**
...
- [x] **Step 4 (controller): booking flow smoke test**
